...
public class AuthorController {
    ...
    public void run() throws NoSuchFieldException, IllegalAccessException, InstantiationException {
    ...
    private void crud(String position, BufferedReader reader) throws NoSuchFieldException, IllegalAccessException, InstantiationException, ClassNotFoundException {
        switch (position) {
    ...
    private void update(BufferedReader reader) throws NoSuchFieldException, IllegalAccessException, InstantiationException, ClassNotFoundException {
        Author author;
    ...
    private void findById(BufferedReader reader) throws NoSuchFieldException, ClassNotFoundException, InstantiationException, IllegalAccessException {
    ...
    private void findAll() throws NoSuchFieldException, InstantiationException, IllegalAccessException {
